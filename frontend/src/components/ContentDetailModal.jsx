...
const ContentDetailModal = ({ content, onClose, onPlayVideo, accessStatus, onExpiredClick }) => {
  ...
  <div style={{ position: 'relative', width: '100%', height: '100%' }}>
    ...
    />
    <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: '80px', zIndex: 99 }} onClick={(e) => e.preventDefault()} />
    <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: '80px', zIndex: 99 }} onClick={(e) => e.preventDefault()} />
  </div>
)}
          {getStreamUrl() && (
            <iframe
